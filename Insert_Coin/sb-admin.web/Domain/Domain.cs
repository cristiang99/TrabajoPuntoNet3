...
namespace sb_admin.web.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 2, nameOption = "Mesas", controller = "Mesas", action = "Index", imageClass = "fa fa-fw fa-bar-chart-o", estatus = true });
            menu.Add(new Navbar { Id = 3, nameOption = "Insumos", controller = "Insumoes", action = "Index", imageClass = "fa fa-fw fa-table", estatus = true });
            menu.Add(new Navbar { Id = 4, nameOption = "Concktail", controller = "Cocktails", action = "Index", imageClass = "fa fa-fw fa-edit", estatus = true });
            menu.Add(new Navbar { Id = 5, nameOption = "Pedidos", controller = "Pedidoes", action = "Index", imageClass = "fa fa-fw fa-desktop", estatus = true });
            return menu.ToList();
        }
